...
$_ ['oa_text_position_manual'] = "Manual integration";
$_ ['oa_text_position_add_widget'] = 'If want to manually integrate the plugin in any twig template :';
$_ ['oa_text_position_add_widget_example'] = 'Adding de code <strong>{{ oasl_widget }}</strong> will integrate our whole widget anywhere you needs.';
$_ ['oa_text_position_add_button'] = 'I just want to add the buttons in a twig template :<br/>';
$_ ['oa_text_position_add_button_example'] = 'Just include the code <strong>{% include "default/template/extension/module/oneall_buttons.twig" %}</strong> somewhere, in a twig template.';
